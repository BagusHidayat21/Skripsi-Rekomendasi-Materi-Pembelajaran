      ...
      <div className="w-full max-w-6xl flex bg-white rounded-2xl shadow-2xl overflow-hidden">
        ...
        <div className="w-full lg:w-1/2 p-8 lg:p-12">
          ...
          <div className="lg:hidden flex items-center gap-2 mb-8">
            ...
            <div>
              <h2 className="text-xl font-bold text-gray-900">EduRecommend</h2>
          ...
          <button
            ...
            disabled={loading}
            className="w-full flex items-center justify-center gap-3 px-4 py-3 border-2 border-gray-300 rounded-lg hover:bg-gray-50 transition-colors mb-6 font-medium text-gray-700 disabled:opacity-50 disabled:cursor-not-allowed"
          >
            ...
            {isLogin ? 'Login' : 'Register'} dengan Google
          </button>
